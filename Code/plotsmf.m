...
text(m(1,4)+veclen*m(1,1),m(2,4)+veclen*m(2,1),m(3,4)+veclen*m(3,1),'x');
text(m(1,4)+veclen*m(1,2),m(2,4)+veclen*m(2,2),m(3,4)+veclen*m(3,2),'y');
text(m(1,4)+veclen*m(1,3),m(2,4)+veclen*m(2,3),m(3,4)+veclen*m(3,3),'z');
